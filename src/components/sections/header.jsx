                ...
                <div className="flex justify-between py-6 px-4 gap-2">
                    ...
                    <div className="md:hidden my-auto text-xl cursor-pointer w-8">
                        <a className="select-none" onClick={() => setOpen(!open)}>&#9776;</a>
                        {
                            ...
                            <DropDownMenu>
                                {NAV.map((link, index) => (
                                    <div key={index} className="px-2 py-2 bg-white dark:bg-gray-800 hover:bg-gray-200 rounded-[15px] transition-colors">
                                        <a href={link.url} onClick={() => setOpen(!open)}>{link.label}</a>
                                    </div>
                                ))}
                                <ThemeToggle className="flex items-center justify-center w-10 h-10 bg-white dark:bg-gray-800 hover:bg-gray-200
                    ...
                    <nav className="hidden md:flex space-x-5 lg:space-x-7 justify-between items-center font-light text-base lg:text-lg">
                        ...
                        <div className="px-3 py-1 rounded-[18px] bg-blue-200 hover:bg-blue-300 dark:bg-blue-900 dark:hover:bg-blue-950 transition-colors duration-300">
                            <a href="">RESUME</a>
                        </div>
