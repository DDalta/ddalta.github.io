                            ...
                            <DropDownMenu>
                                {NAV.map((link, index) => (
                                    <div key={index} className="px-2 py-2 bg-white hover:bg-gray-200 dark:bg-gray-950 dark:hover:bg-gray-900 rounded-[15px] transition-colors">
                                        ...
                                        <HashLink smooth to={link.url} onClick={() => setOpen(!open)}>{link.label}</HashLink>
                                    </div>
                                ))}
                                <div className="px-2 py-2 bg-blue-300 hover:bg-blue-400 dark:bg-blue-900 dark:hover:bg-blue-950 rounded-[15px] transition-colors">
